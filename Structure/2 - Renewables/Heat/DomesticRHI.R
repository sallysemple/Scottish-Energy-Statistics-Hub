  ...
  tagList(
    ...
    tabsetPanel(
      ...
      tabPanel("Installations by region",
               fluidRow(
                 column(10, h3("Data - Number of domestic RHI accredited applications by region, Scotland, April 2023", style = "color: #39ab2c;  font-weight:bold")),
      ...
      tabPanel("Heat generated",
    fluidRow(
    column(10, h3("Data - Domestic RHI - heat generated by technology, April 2014 - March 2023", style = "color: #39ab2c;  font-weight:bold")),
...
DomesticRHI <- function(input, output, session) {
  ...
  output$DomesticRHISubtitle <- renderText({
    ...
    paste("Scotland, Apr 2014 - Mar 2023")
  })
  ...
  output$SubtitleYearText2 <- renderUI({
    column(10, h3(paste("Number of full accreditations on/off the gas grid by aggregated rural/urban classification, Domestic -", "April 2014 to March 2023") , style = "color: #39ab2c;  font-weight:bold"))
  ...
  output$DomesticRHITable = renderDataTable({
    ...
    datatable(
      ...
      options = list(
        ...
        fixedColumns = FALSE,
        autoWidth = TRUE,
        title = "Domestic RHI heat generated and capacity by technology, Scotland, April 2014 - March 2023",
        dom = 'ltBp',
        buttons = list(
          list(extend = 'copy'),
          list(
  ...
  output$DomesticRHIRegionTable = renderDataTable({
    ...
    datatable(
      ...
      options = list(
        ...
        fixedColumns = FALSE,
        autoWidth = TRUE,
        title = "Number of domestic RHI accredited applications by region, Scotland, April 2023",
        dom = 'ltBp',
        buttons = list(
          list(extend = 'copy'),
          list(
  ...
  output$DomRHIUrbanRuralTable = renderDataTable({
    ...
    datatable(
      ...
      options = list(
        ...
        fixedColumns = FALSE,
        autoWidth = TRUE,
        title = paste("Number of full accreditations on/off the gas grid by aggregated rural/urban classification, Domestic", "November 2011 to March 2023"),
        dom = 'ltBp',
        buttons = list(
          list(extend = 'copy'),
          list(
 ...
 observeEvent(input$ToggleTable1, {
  ...
  output$DomesticRHI.png <- downloadHandler(
    ...
    content = function(file) {
      ...
      DomesticRHIChart <-
        DomesticRHIChart +
        labs(subtitle = "Scotland, Apr 2014 - March 2023") +
        ylim(
...
output$DomRHIUrbanRuralSubtitle <- renderText({
  ...
  paste("Scotland,","April 2014 to March 2023")
})
...
output$DomRHIUrbanRural.png <- downloadHandler(
  ...
  content = function(file) {
    ...
    DataChart <-
      DataChart +
      labs(subtitle = paste("Scotland, April 2014 to March 2023")) 
