...
AverageBillLAOutput <- function(id) {
  ...
  tagList(
    ...
    tabPanel("Electicity cost breakdown",
             fluidRow(
               column(10, h3("Data - Average variable unit costs and standing charges for standard electricity in 2021", style = "color: #68c3ea;  font-weight:bold")),
    ...
    tabPanel("Gas cost breakdown",
             fluidRow(
               column(10, h3("Data - Average variable unit costs and standing charges for standard gas in 2021", style = "color: #68c3ea;  font-weight:bold")),
  ...
  output$ElecUnitTable = renderDataTable({
    ...
    datatable(
      ...
      options = list(
        ...
        autoWidth = TRUE,
        ordering = TRUE,
        title = "Average variable unit costs and standing charges for standard electricity in 2021",
        dom = 'ltBp',
        buttons = list(
          list(extend = 'copy'),
          list(
  ...
  output$GasUnitTable = renderDataTable({
    ...
    datatable(
      ...
      options = list(
        ...
        autoWidth = TRUE,
        ordering = TRUE,
        title = "Average variable unit costs and standing charges for standard gas in 2021",
        dom = 'ltBp',
        buttons = list(
          list(extend = 'copy'),
          list(
