...
GasConsumptionOutput <- function(id) {
  ...
  tagList(
    ...
    tabPanel("Local Authority",
             fluidRow(
               column(10, h3("Data - Average annual household consumption of gas by local authority, 2021", style = "color: #34d1a3;  font-weight:bold")),
  ...
  output$GasConsumptionLATable = renderDataTable({
    ...
    datatable(
      ...
      options = list(
        ...
        fixedColumns = FALSE,
        autoWidth = TRUE,
        title = "Average annual household consumption of gas by local authority, 2021",
        dom = 'ltBp',
        buttons = list(
          list(extend = 'copy'),
          list(
